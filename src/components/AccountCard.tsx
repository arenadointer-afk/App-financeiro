...
export const AccountCard: React.FC<AccountCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/5">
        {!conta.paga ? (
          <button
            type="button"
            onClick={() => onPay(conta)}
            className="flex-1 py-2.5 px-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-md shadow-emerald-600/25 transition-all"
          >
          ...
          <button
            ...
            className="flex-1 py-2.5 px-3 rounded-xl bg-white/5 hover:bg-white/10 active:scale-[0.98] text-neutral-300 font-medium text-xs flex items-center justify-center gap-1.5 border border-white/10 transition-all"
          >
        ...
        <button
          ...
          className={`w-10 h-9 rounded-xl flex items-center justify-center transition-colors border ${
            expanded
      ...
      {expanded && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 mt-3 pt-3 border-t border-white/10 text-xs animate-in slide-in-from-top-2 duration-150">
          <button
            type="button"
            onClick={() => onCopyPix(conta)}
            className="p-2 rounded-lg bg-white/5 hover:bg-white/10 text-neutral-300 flex items-center justify-center gap-1.5 transition-colors border border-white/5"
          >
          ...
          <button
            ...
            className="col-span-2 p-2 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-400 flex items-center justify-center gap-1.5 transition-colors border border-red-500/20"
          >
